...
void FAuraGameplayTags::InitializeNativeGameplayTags()
{
	...
	//如果用中文，编码会不过，传入一个非UTF-8编码的字符串会报错
	//UGameplayTagsManager::Get().AddNativeGameplayTag(FName("Attributes.Secondary.Armor"), FString("减少受到的伤害，提高格挡率"));
	//GameplayTags.Attributes_Secondary_Armor = UGameplayTagsManager::Get().AddNativeGameplayTag(FName("Attributes.Secondary.Armor"), FString(TEXT("减少受到的伤害，提高格挡率 %s")));
	...
	GameplayTags.Effect_HitReact = UGameplayTagsManager::Get()
			.AddNativeGameplayTag(
				...
				FString("Tag Granted Hit Reacting")
			);
